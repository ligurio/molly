...
[![Coverage Status](https://coveralls.io/repos/github/ligurio/molly/badge.svg?branch=dev)](https://coveralls.io/github/ligurio/molly?branch=dev)
...
```sh
$ luarocks install --local --server=https://luarocks.org/dev molly
```
